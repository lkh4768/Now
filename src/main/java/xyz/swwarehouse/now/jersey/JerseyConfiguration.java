...
import xyz.swwarehouse.now.rest.TimeResource;
...
public class JerseyConfiguration extends PackagesResourceConfig {
	...
	public JerseyConfiguration() {
		...
		super("xyz.swwarehouse.now.rest");
	}
	...
	public Set<Object> getSingletons() {
		...
		getProperties().put(ClassNamesResourceConfig.PROPERTY_CLASSNAMES, TimeResource.class.getCanonicalName());
